...
color splined_color(std::vector<float> x, std::vector<color> colors, float index)
{
	...
	//cout << coeffsBlue[0] << "\n";
	return color(
		min(1.f, (max(0.f, coeffsRed[0] * pow(index, 3) + coeffsRed[1] * pow(index, 2) + coeffsRed[2] * index + coeffsRed[3]))),
		min(1.f, (max(0.f, coeffsGreen[0] * pow(index, 3) + coeffsGreen[1] * pow(index, 2) + coeffsGreen[2] * index + coeffsGreen[3]))),
		min(1.f, (max(0.f, coeffsBlue[0] * pow(index, 3) + coeffsBlue[1] * pow(index, 2) + coeffsBlue[2] * index + coeffsBlue[3]))));
}